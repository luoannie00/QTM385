...
The misclassification rates for all classifiers are quite close to one another, with native bayes have the misclassification rate a little bit higher than the others. From the deviance perspect, we could see that QDA performs the best here(with LDA have a bit higher deviance), while multinomial logistic regression classifier have a relatively huge deviance.[but also do notice that how the deviance enlarge the differences among the models]
```{r}
