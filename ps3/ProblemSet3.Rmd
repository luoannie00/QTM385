...
```{r p2p1}
p2p1_imp_pred <- subset(o_train, select=c(season, paul_lieberstein, greg_daniels, b_j_novak, imdb_rating))
...
```
The LOOCV of this new model is slightly smaller than full model.
...
p2p2_ridgem <- glmnet::glmnet(x = p2p2_pred, y = p2p2_out, family = "gaussian", alpha = 0) #100 possible values of lambda
