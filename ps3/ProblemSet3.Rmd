...
p2p3_optimal_lassom <- glmnet(x=p2p3_pred, y=p2p3_out, family="gaussian", alpha=1, lambda=0.03343)
#plot
cf1 <- c()
cf2 <- c()
for (i in 1:37) {
...
#c_optimal_lassom <- glmnet(x=lasso_predictor, y=lasso_outcome, family="gaussian", alpha=1, lambda=0.03343)
```
