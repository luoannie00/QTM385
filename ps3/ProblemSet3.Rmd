...
approachPlot<-qplot(S.F.Ratio,Outstate,data=c_train_q4,geom=c("point","smooth"),xlab="out of state tuition",ylab="student/faculty ratio")
approachPlot
...
lmApprochPlot<-qplot(S.F.Ratio,Outstate,data=c_train_q4,geom=c("point","smooth"),method="lm",xlab="out of state tuition",ylab="student/faculty ratio")
lmApprochPlot
```
...
predResultPlot<-qplot(S.F.Ratio,predOutState,data=predResult,geom=c("point"),xlab="out of state tuition prediction",ylab="student/faculty ratio")
predResultPlot
```
...
for(i in 5:20){
  ...
  cubicSplinePredResultPlot<-qplot(S.F.Ratio,predOutState,data=cubicSplinePredResult,geom=c("point","smooth"),xlab="out of state tuition prediction",ylab="student/faculty ratio", main = toString(i))
  print(cubicSplinePredResultPlot)
  print(i)
}
#smoothing spline
#compare and find the min GCV in range lambda=1:100
bestLambda<-0
smoothGcv<--1
tempNum<-seq(0,100,0.01)
for(i in tempNum){
  smoothSplineModel<-smooth.spline(c_train_q4$Outstate,c_train_q4$S.F.Ratio,lambda=i)
...
print(bestLambda)
optSmoothSplineModel<-smooth.spline(c_train_q4$Outstate,c_train_q4$S.F.Ratio,lambda=bestLambda)
