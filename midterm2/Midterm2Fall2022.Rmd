...
### Part 3 Solution
Euclidean distance between each obs. to mean. need to code this 解释没写完
...
It's easy to find separators between 0 and 1, which makes LR shine, because LR draws simple linear boundaries.
